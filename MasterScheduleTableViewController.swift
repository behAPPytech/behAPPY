//
//  MasterScheduleTableViewController.swift
//  behAPPy
//
...
class MasterScheduleTableViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        let selectedAssignment = self.assignments[indexPath.row]
        self.delegate?.assignmentSelected(selectedAssignment)
        
        if let scheduleDetailViewController = self.delegate as? ScheduleDetailViewController    {
